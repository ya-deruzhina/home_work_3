...
ВНИМАНИЕ!
через Браузер: запрос post, html render и список активных ссылок на каждую страницу
через Postman: запрос get, сериалайзер и результат json
...
- Навести красоту, удалить лишнее